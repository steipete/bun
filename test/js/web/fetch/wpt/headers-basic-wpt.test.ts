// Runs the vendored Web Platform Tests fetch/api/headers/headers-basic.any.js
// against Bun's Headers. The .any.js file is byte-identical to upstream; this
// driver follows textstream-wpt.test.ts.
//
...
const src = readFileSync(join(import.meta.dir, "headers-basic.any.js"), "utf8");
