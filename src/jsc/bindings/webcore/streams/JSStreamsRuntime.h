...
//     context = the adapter.
//   onReadDirectStreamPullFulfilled: readDirectStream's async pull() resolved; ends the sink
//     controller unless pull() already closed it. context = the JSDirectSinkCloseState.
